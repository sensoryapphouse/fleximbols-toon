...
# 1. Salamander (No complex belly patch, just spots which are fully inside)
salamander_defs = """
...
<clipPath id="newtBodyClip">
  <ellipse cx="250" cy="270" rx="80" ry="50"/>
</clipPath>
"""
newt_content = """
<!-- Tail -->
...
<!-- Base Strokes for Body and Head (drawn underneath to form a seamless outer border) -->
...
<clipPath id="quailBodyClip">
  <path d="M 160 280 C 160 180, 380 180, 380 280 C 380 380, 160 380, 160 280 Z"/>
</clipPath>
"""
quail_content = """
<!-- Legs (Black outlines behind) -->
<path d="M 230 320 L 230 410 L 210 430 M 230 410 L 250 430" fill="none" stroke="#1a1a1a" stroke-width="18"/>
<path d="M 310 320 L 310 410 L 290 430 M 310 410 L 330 430" fill="none" stroke="#1a1a1a" stroke-width="18"/>
<!-- Legs (Colored strokes on top) -->
...
<!-- Body Fill -->
<path d="M 160 280 C 160 180, 380 180, 380 280 C 380 380, 160 380, 160 280 Z" fill="url(#quailBody)" stroke="none"/>

<!-- Belly Patch (Clipped) -->
<path d="M 160 280 C 160 400, 380 400, 380 280 C 380 300, 160 300, 160 280 Z" fill="url(#quailBelly)" stroke="none" clip-path="url(#quailBodyClip)"/>

<!-- Body Stroke -->
<path d="M 160 280 C 160 180, 380 180, 380 280 C 380 380, 160 380, 160 280 Z" fill="none"/>
...
<clipPath id="birdBodyClip">
  <ellipse cx="256" cy="280" rx="130" ry="90"/>
</clipPath>
"""
bird_content = """
<!-- Tail -->
...
<!-- Legs (Colored strokes on top) -->
<path d="M 210 320 L 210 420 L 190 440 M 210 420 L 230 440" fill="none" stroke="#f57f17" stroke-width="12"/>
<path d="M 290 320 L 290 420 L 270 440 M 290 420 L 310 440" fill="none" stroke="#f57f17" stroke-width="12"/>

<!-- Body Fill -->
<ellipse cx="256" cy="280" rx="130" ry="90" fill="url(#birdGrad)" stroke="none"/>

<!-- Belly Patch (Clipped) -->
<path d="M 120 320 C 220 420, 360 420, 390 320 Z" fill="url(#birdBelly)" stroke="none" clip-path="url(#birdBodyClip)"/>

<!-- Body Stroke -->
<ellipse cx="256" cy="280" rx="130" ry="90" fill="none"/>
...
<clipPath id="partBodyClip">
  <ellipse cx="256" cy="300" rx="110" ry="85"/>
</clipPath>
"""
part_content = """
<!-- Tail -->
...
<!-- Legs (Black outline) -->
<path d="M 210 320 L 210 430 L 190 450 M 210 430 L 230 450" fill="none" stroke="#1a1a1a" stroke-width="18"/>
<path d="M 300 320 L 300 430 L 280 450 M 300 430 L 320 450" fill="none" stroke="#1a1a1a" stroke-width="18"/>
<!-- Legs (Colored) -->
...
<!-- Body Fill -->
<ellipse cx="256" cy="300" rx="110" ry="85" fill="url(#partBody)" stroke="none"/>

<!-- Rust patch (Clipped) -->
<path d="M 140 310 C 140 400, 360 400, 360 310 C 360 330, 140 330, 140 310 Z" fill="url(#partPatch)" stroke="none" clip-path="url(#partBodyClip)"/>

<!-- Body Stroke -->
<ellipse cx="256" cy="300" rx="110" ry="85" fill="none"/>
...
<clipPath id="sharkBodyClip">
  <path d="M 60 280 C 60 180, 420 200, 420 280 C 420 360, 60 380, 60 280 Z"/>
</clipPath>
"""
shark_content = """
<!-- Top Fin -->
...
<!-- Body Fill -->
<path d="M 60 280 C 60 180, 420 200, 420 280 C 420 360, 60 380, 60 280 Z" fill="url(#sharkBody)" stroke="none"/>

<!-- Belly Patch (Clipped aggressively so it perfectly meets the bottom edge) -->
<!-- Drawing it much larger downwards to ensure it hits the clip boundary -->
<path d="M 90 320 C 220 320, 360 320, 420 310 C 420 420, 60 420, 90 320 Z" fill="url(#sharkBelly)" stroke="none" clip-path="url(#sharkBodyClip)"/>

<!-- Body Stroke (drawn over the belly edge to ensure a flawless black border) -->
<path d="M 60 280 C 60 180, 420 200, 420 280 C 420 360, 60 380, 60 280 Z" fill="none"/>
...
<!-- Legs (Black outlines) -->
<path d="M 220 270 L 190 380 Q 180 400 190 420 L 210 440 M 190 420 L 170 440" fill="none" stroke="#1a1a1a" stroke-width="20"/>
<path d="M 290 270 L 320 380 Q 330 400 320 420 L 300 440 M 320 420 L 340 440" fill="none" stroke="#1a1a1a" stroke-width="20"/>
<!-- Legs (Colored) -->
...
<!-- Horns (Black outlines) -->
<path d="M 310 220 C 260 180, 220 280, 280 280" fill="none" stroke="#1a1a1a" stroke-width="22"/>
<path d="M 350 220 C 400 180, 440 280, 380 280" fill="none" stroke="#1a1a1a" stroke-width="22"/>
<!-- Horns (Colored) -->
...
<!-- Highlight core (Fixed invalid syntax by removing duplicate stroke attribute) -->
...
print("Generated SVGs successfully with strict layer clipping and stroke duplication.")
